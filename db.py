...
def save_lot_in_bidding_lots(con, lot):
    ...
    cur.execute("INSERT INTO bidding_lots(type, number, category_id, source_url, advance_amount, "
                ...
                "VALUES (%s, %s, %s, %s, null, null, null, null, %s, %s, %s, true, true, now(), now(), %s, null, "
                "%s, %s, "
                "%s, %s, null, null, null, null, 0, null, null, null, null, null)", (
                    lot.type, lot.number, lot.category_id, lot.source_url, lot.started_at, lot.ended_at,
...
def save_lot_in_bidding_lots_translations(con, lot):
    ...
    cur = con.cursor()
    cur.execute("INSERT INTO bidding_lots_translations(lot_id, name, description_short, description_long, "
                "purchase_conditions, delivery_conditions, delivery_time, locale, delivery_address, measure) "
                "VALUES (%s, %s, null, null, %s, %s, %s, %s, %s, null)", (
                    lot_id, lot.name, lot.purchase_conditions, lot.delivery_conditions, lot.delivery_time,
